...
class Toolbox(Box):
    def __init__(self, **kwargs):
        ...
        self.btn_ssregion = Button(
            name="toolbox-button",
            child=icons.image("ssregion", widget_name="button-label", size=22),
        ...
        self.btn_ssfull = Button(
            name="toolbox-button",
            child=icons.image("ssfull", widget_name="button-label", size=22),
        ...
        self.btn_screenrecord = Button(
            name="toolbox-button",
            child=icons.image("screenrecord", widget_name="button-label", size=22),
        ...
        self.btn_ocr = Button(
            name="toolbox-button",
            child=icons.image("ocr", widget_name="button-label", size=22),
            on_clicked=self.ocr,
            h_expand=False,
            v_expand=False,
            h_align="center",
        ...
        self.btn_color = Button(
            ...
            child=icons.image("colorpicker", widget_name="button-label", size=22),
            h_expand=False,
            v_expand=False,
            h_align="center",
            v_align="center",
        ...
        self.btn_emoji = Button(
            name="toolbox-button",
            child=icons.image("emoji", widget_name="button-label", size=22),
    ...
    def update_screenrecord_state(self):
        ...
        if running:
            icons.set_image(self.btn_screenrecord.get_child(), "stop")
            self.btn_screenrecord.add_style_class("recording")
        else:
            icons.set_image(self.btn_screenrecord.get_child(), "screenrecord")
