...
class NotificationBox(Box):
    ...
    def create_close_button(self):
        self.close_button = Button(
            ...
            child=icons.image("cancel", widget_name="notif-close-label", size=18),
    ...
    def close_notification(self):
        if not self._destroyed:
            try:
                if not hasattr(self.notification, "close"):
                    logger.debug(
                        f"Notification {self.notification.id} does not support close(); skipping timeout close."
                    )
                    self.stop_timeout()
                    return False
...
class NotificationHistory(Box):
    def __init__(self, **kwargs):
        ...
        self.header_clean = Button(
            name="nhh-button",
            child=icons.image("trash", widget_name="nhh-button-label", size=18),
        ...
        self.dnd_label = icons.image("notifications_off", widget_name="dnd-label", size=20)
        ...
        self.no_notifications_label = icons.image(
            "notifications_clear",
            widget_name="no-notifications-label",
            size=32,
            v_align="fill",
            h_align="fill",
            v_expand=True,
...
class NotificationContainer(Box):
    ...
    def __init__(self, **kwargs):
        ...
        self.prev_button = Button(
            name="nav-button",
            child=icons.image("chevron_left", widget_name="nav-button-label", size=18),
            on_clicked=self.show_previous,
        )
        self.close_all_button = Button(
            name="nav-button",
            child=icons.image("cancel", widget_name="nav-button-label", size=18),
        ...
        self.next_button = Button(
            name="nav-button",
            child=icons.image("chevron_right", widget_name="nav-button-label", size=18),
