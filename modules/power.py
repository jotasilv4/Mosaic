...
class PowerMenu(Box):
    def __init__(self, **kwargs):
        ...
        self.btn_lock = Button(
            ...
            child=icons.image("lock", widget_name="button-label", size=22),
        ...
        self.btn_suspend = Button(
            name="power-menu-button",
            child=icons.image("suspend", widget_name="button-label", size=22),
        ...
        self.btn_logout = Button(
            name="power-menu-button",
            child=icons.image("logout", widget_name="button-label", size=22),
        ...
        self.btn_reboot = Button(
            name="power-menu-button",
            child=icons.image("reboot", widget_name="button-label", size=22),
        ...
        self.btn_shutdown = Button(
            name="power-menu-button",
            child=icons.image("shutdown", widget_name="button-label", size=22),
